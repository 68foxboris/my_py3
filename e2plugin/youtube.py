...
#               entryUri = (_("YouTube TV URL"), config.plugins.browser.youtube_uri)
        entryShowHelp = (_("Do not show YouTube TV Starter again"), config.plugins.browser.youtube_showhelp)
        entryEnableNtpd = (_("Enable Ntpd when start YoutubeTV"), config.plugins.browser.youtube_enable_ntpd)
        entryNtpdUri = (_("Ntpd URL"), config.plugins.browser.youtube_ntpd_url)
